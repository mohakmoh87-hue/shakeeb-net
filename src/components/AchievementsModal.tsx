          ...
          <>
            ...
            <details className="mt-4 rounded-xl border border-slate-200 bg-white p-3 text-xs text-slate-600">
              ...
              <p className="mt-2 leading-6">
                ...
                محدود بين ٠٫٦ و١٫٦). بطاقة بلا زمن (كالتوصيل) معاملها ١. وأي زمن يتجاوز ٤ ساعات يُتجاهَل
                في المتوسط (نسيان ضغط «إنجاز» غالباً). ولا تتويج بأقلّ من {d.minCards} بطاقات.
              </p>
