...
export async function POST(request: Request) {
  ...
  if (ids.length > 0) {
    // أرشفة بدل الحذف: تبقى البطاقة بالأرشيف شهرين ثم تُحذف نهائياً (أو يحذفها المدير يدوياً).
    // صور العمل تبقى مع البطاقة لعرضها من الأرشيف — وتُحذف معها بتنظيف الشهرين/الحذف اليدوي.
    ...
    // لا قيد ولا تراجع — والبطاقات تُحذف بعد شهرين فيضيع أصل الرقم نهائياً.
