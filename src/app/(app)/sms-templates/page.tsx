...
const EVENTS: { type: string; name: string; hint: string }[] = [
  ...
  // 🔄 (بلاغ محمد 2026-08-27) كان النوعُ موجوداً في الخادم (يُرسِل بنصّه الافتراضيّ) وغائباً
  // عن هذه القائمة — فلا أحدَ من الوكلاء يرى نصَّه أو يعدّله أو يضع صورتَه. سطرُ العرض وحدَه.
  { type: "expiredSince", name: "انتهى الاشتراك", hint: "تُرسل تلقائياً لمن انتهى اشتراكه منذ N يوم — تعمل فقط للمكاتب المفعَّل عندها «رسالة المنتهين» في إعدادات المكتب (عدد الأيّام ووقت الإرسال هناك)" },
